...
To install `ecoCopula` while it is not on CRAN, use the `devtools` package.
```{r, echo=FALSE, eval=FALSE}
#install.packages("devtools")
devtools::install_github("gordy2x/ecoCopula", upgrade = "never")
```
...
bryce_marg_all <- stackedsdm(bryceord, formula_X = ~ slope, data = brycesite, family="ordinal",ncores = 2)
